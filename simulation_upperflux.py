...
from create_lookupfiles_upperflux import *
import scipy 
...
factor=100				#num of loops when generating the toy models
...
###
m_DM_array=np.array([10.,8.,6.,4.,3.5])
...
filename_dm='FINAL_CF4_5keV_sigmaup_precision_angle_3sigma_02.txt'
